...
; v0.2.2 (changes made by Niels Saarloos)
; Minor bugfixes
...
; v0.2.1 (Written by Niels Saarloos, originator of the Shopfloor Programmer for EdingCNC)
...
;############################################################################################
Parameter usage:
Volatile parameters: #3000..#3154
Non-Volatile parameters: #4700..#4920

Non-Volatile Parameter assignment per function:
Function			Non-Volatile parms
HEADERS				  -					
FLATTEN				#4901..#4919
SIDEMILLING			#4741..#4759
SQUARECONTOUR		#4781..#4798
ROUNDCONTOUR		#4823..#4838
SQUAREPOCKET		#4841..#4858
ROUNDPOCKET			#4861..#4878
SLOTTING			#4881..#4898
SLITTING			#4721..#4738
SQUARE_DRILLING		#4701..#4718
CIRCULAR_DRILLING	#4801..#4819
TAPPING				#4761..#4772
PARTPROGRAM			  -
WARM_UP				#4921..#4928
...
Sub WARM_UP
	Dlgmsg "Shopfloor Warm-Up" "Mode" 4921 "Speed 1 (rpm)" 4922 "Time 1 (sec)" 4923 "Speed 2 (rpm)" 4924 "Time 2 (sec)" 4925 "Speed 3 (rpm)" 4926 "Time 3 (sec)" 4927 "Axis speed (mm/min)" 4928
	If [#5398 == 1]
		If [[#4921>=1] AND [#4921<=3] AND [#4922>=100] AND [#4924>#4922] AND [#4926>#4924]]  ; Check input parameter integrity
			If [[#4921 == 2] OR [#4921 == 3]] ; mode is 1 (include axis movement for lubrication purposes)
				Gosub home_all
				M6 T0
				TCAGuard off
				F[#4928]
				G53 G1 Z#5113		;Move Z up
				G53 G1 X#5101 Y#5102	;Move negative
				G53 G1 X#5111 Y#5112	;Move positive
				G53 G1 Z#5103		;Move Z down
				G53 G1 Z#5113		;Move Z up
				G53 G1 X#5081 Y#5082	;Move XY home
				TCAGuard on
				Gosub home_all
			Endif
			If [[#4921 == 1] OR [#4921 == 3]]
				M3
				S[#4922]		; Spindle to speed 1		
				G4 P[#4923]		; wait time 1
				S[#4924]		; Spindle to speed 2
				G4 P[#4925]		; wait time 2
				S[#4926]		; Spindle to speed 3
				G4 P[#4927]		; wait time 3
				M5			; Turn spindle off
			Endif
		Else
			msg "Input parameters incorrect!!!"
